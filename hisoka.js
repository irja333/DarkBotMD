...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/ebf0209032d6f527502b4.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Prices\n⭔ 10k Per Group via DANA\n\n Premium Price Bot\nUntuk detail hubungi owner\nhttps://wa.me/6282275576880 (Owner)` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply(''*Chat Owner* : *https://bit.ly/ir_ja*')
            }
            break
            case 'chat': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/irja_official'
                                }
                            }, {
                                urlButton: {
                                    displayText: 'Group',
                                    url: 'https://chat.whatsapp.com/Fd92L258maQ6lWjIua6Djq'
                                }
                            }, {
                                quickReplyButton: {
